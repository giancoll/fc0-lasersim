...
#warning Using deprecated AsInt.
    ...
    ///
    /// \deprecated This method is to dangerous, and depends on "undefined"
    /// C++ behavior.  Use GetChannelId().AsString().c_str() if you need a
    /// pointer to a c-string.  Otherwise, directly use
    /// GetChannelId().AsString() to get the channel id as a string.
    /// operator const char*() const METHOD_DEPRECATED {return AsString().c_str();}
